...
var WrapUpNamespaceError  = errors.NamespaceveError
    ...
    scan: function(what, from, callback){
        ...
        fs.readFile(modulefull, "utf-8", function(err, src){
            ...
            try {
                ...
                storage.put(modulefull, {err: true})
                this.emit("warn", err = new WrapUpJavaScriptError(modulefull, from, e.lineNumber, e.column))
                return callback(err)
            }
