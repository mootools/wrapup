...
var WrapUpNotInPathError = prime({

    inherits: WrapUpError,

    type: "not-in-path",

    constructor: function WrapUpNotInPathError(module, source, path){
        WrapUpError.call(this, "Not allowed to require module", module, source)
        this.path = path
    }
...
var WrapUpResolveError = prime({
    ...
    constructor: function WrapUpResolveError(module, source){
        WrapUpError.call(this, "Resolve Error: could not resolve module " + module + " in source " + source, module, source)
    }
...
exports.NotInPathError       = WrapUpNotInPathError
