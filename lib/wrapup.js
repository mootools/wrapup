...
var modeMethod = function(name){
    return function(callback){
        ...
        require('./output/' + name)(this, function(err, code){
...
var WrapUp = prime({
    ...
    options: function(options){
        ...
        if (options.path != null) _options.path = options.path
    ...
    browser: modeMethod('browser'),
    amd: modeMethod('amd'),
    amdOneFile: modeMethod('amdOneFile'),
    graph: modeMethod('graph'),
